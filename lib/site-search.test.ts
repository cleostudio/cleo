...
describe('searchSiteCatalog', () => {
  ...
  it('finds ocean guides and their features', () => {
    ...
    expect(hrefs('black sea')[0]).toBe('/oceans/black-sea')
    expect(hrefs('baltic sea')[0]).toBe('/oceans/baltic-sea')
    expect(hrefs('north sea')[0]).toBe('/oceans/north-sea')
    expect(hrefs('gulf of mexico')[0]).toBe('/oceans/gulf-of-mexico')
    expect(hrefs('east china sea')[0]).toBe('/oceans/east-china-sea')
    ...
    expect(hrefs('bosporus strait')[0]).toBe('/oceans/black-sea')
    expect(hrefs('german baltic coast')[0]).toBe('/oceans/baltic-sea')
