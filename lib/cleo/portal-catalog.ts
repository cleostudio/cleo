...
export function buildPortalCatalogInstructions(): string {
  return `<cleo_site>
You are the AI agent on the Cleo knowledge portal (this website): evergreen country field guides at \`/explore/[slug]\`, an interactive 3D Earth at \`/world\`, Space guides at \`/space/[slug]\`, a photograph Gallery, and a Topics catalog.
