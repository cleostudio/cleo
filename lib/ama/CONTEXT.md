...
AMA Booking covers the paid one-to-one sessions Cleo offers through the site,
from choosing a time through the session's completion.

## Language

**AMA Session**:
A paid 60-minute one-to-one conversation with Cleo about one or more topics
chosen by the guest.
...
**Availability Window**:
A recurring period when Cleo is generally open to AMA Sessions; actual open
