...
export function allTopics(): Topic[] {
  ...
  return [
    ...
    },
    {
      ...
      name: 'Rivers',
      description:
        'Evergreen field guides for major rivers across Africa, Asia, and Europe, Americas & Oceania — orientation, course features, facts, sources, and curated photographs.',
