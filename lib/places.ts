...
import { placeGuideDraftsBatch10 } from '~/lib/places-batch10'
import { placeGuideDraftsBatch11 } from '~/lib/places-batch11'
...
import { placeGuideDraftsBatch16 } from '~/lib/places-batch16'
import { placeGuideDraftsBatch17 } from '~/lib/places-batch17'
import { placeGuideDraftsBatch18 } from '~/lib/places-batch18'
import { placeGuideDraftsBatch19 } from '~/lib/places-batch19'
import { placeGuideDraftsBatch20 } from '~/lib/places-batch20'
import { placeGuideDraftsBatch21 } from '~/lib/places-batch21'
import { placeGuideDraftsBatch22 } from '~/lib/places-batch22'
import { placeGuideDraftsBatch23 } from '~/lib/places-batch23'
import { placeGuideDraftsBatch24 } from '~/lib/places-batch24'
...
const placeGuideDrafts: PlaceGuideDraft[] = [
  ...
  ...(placeGuideDraftsBatch10 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch11 as PlaceGuideDraft[]),
  ...
  ...(placeGuideDraftsBatch16 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch17 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch18 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch19 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch20 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch21 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch22 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch23 as PlaceGuideDraft[]),
  ...(placeGuideDraftsBatch24 as PlaceGuideDraft[]),
]
