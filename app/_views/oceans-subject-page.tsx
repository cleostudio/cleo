...
export function OceansSubjectPageView({ slug }: { slug: string }) {
  const subject = getOceanSubject(slug)
  if (!subject) notFound()
  ...
  return (
    <article className="field-guide mx-auto w-full max-w-content px-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <PixelCluster variant={9} className="enter shrink-0" />
      </div>
      ...
      <section
        ...
        aria-labelledby="oceans-about"
      >
        <h2 id="oceans-about" className="guide-label">
          Orientation
        </h2>
      ...
      <section
        ...
        aria-labelledby="oceans-features"
      >
        <h2 id="oceans-features" className="guide-label">
          Features
        </h2>
      ...
      <section
        ...
        aria-labelledby="oceans-facts"
      >
        <h2 id="oceans-facts" className="guide-label">
          Fact plate
        </h2>
        <dl className="spec-plate spec-plate-guide mt-3">
          ...
          <div>
            <dt>Surface area</dt>
            <dd>{subject.facts.surfaceArea}</dd>
          </div>
          <div>
            <dt>Mean depth</dt>
            <dd>{subject.facts.meanDepth}</dd>
          </div>
          <div>
            <dt>Max depth</dt>
            <dd>{subject.facts.maxDepth}</dd>
          </div>
          <div>
            <dt>Bordering</dt>
            <dd>{subject.facts.bordering}</dd>
          </div>
          <div>
            <dt>Catalog</dt>
            <dd>{subject.code}</dd>
      ...
      <section
        ...
        aria-labelledby="oceans-sources"
      >
        <h2 id="oceans-sources" className="guide-label">
          Sources
        </h2>
      ...
      >
        <Link href="/oceans" className="text-sm text-muted-foreground hover:text-foreground">
          ← All ocean guides
        </Link>
      </p>
    </article>
