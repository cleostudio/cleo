...
description: >-
  Historical tutorial for the 2024 v2 stack. It does not apply to the current v3
  site.
...
1. Return to the command line and run `npm create sanity@latest -- --template clean --create-project "Cleo Demo" --dataset production`. Remember to replace "Cleo Demo" with your own project name.
