...
image generation, live reasoning / web-search activity, curated guide
grounding, Ask-from-guide entry points, and a tab-scoped session that
survives reload until New chat.
...
- Cleo agent: `components/cleo/*`, `lib/cleo/*` (instructions include the
  ...
  curated topic photographs when a visual helps; turns about catalog subjects
  also receive curated guide excerpts; portal tools can browse/list/compare
  guides and invented guide slugs are stripped in the UI)
