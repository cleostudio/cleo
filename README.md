...
- Cleo agent: `components/cleo/*`, `lib/cleo/*` (instructions include the
  ...
  (`blog/` aliases `writing/`); matched turns also ground clipped orientation
  prose (common names, Messier IDs, uppercase ISO codes, essay-related
  subjects). Smoke with `pnpm verify:cleo-ask`
...
theme/dock coexistence, and an Explore/Space “Ask Cleo about …” deep link.
