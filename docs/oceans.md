...
circulation, bathymetry, climate role, sources, and curated photographs (ten
guides). Topics catalog lists Oceans alongside Countries, Space, Civilizations,
Cities, and Rivers (`lib/topics.ts`).
