#!/usr/bin/env node
/**
 * Pin known-good Commons heroes for batch19 weak/wrong auto-curations.
 *
 *   node scripts/places/handpick-batch19.mjs
...
const UA = 'cleo-places-curate/1.0 (batch19-handpick-persist)'

/** slug → Commons file title */
const HANDPICKS = {
  knoxville: 'File:Downtown Knoxville 2025a.jpg',
  mesa: 'File:Downtown Mesa Arizona.jpg',
  cincinnati:
    'File:Cincinnati Skyline from Roebling Bridge, Covington, KY.jpg',
  'london-ontario':
    'File:View of Downtown, London, Ontario and the Thames River.jpg',
  liverpool: 'File:Liverpool Pier Head from ALbert Dock.jpg',
  'novi-sad':
    'File:Petrovaradin Fortress II, Novi Sad, Serbia 14.09.2016.jpg',
  gdansk: 'File:Old Town houses and port crane along Motława, Gdańsk.jpg',
  mississippi: 'File:Mississippi River Bridge in Vicksburg, Mississippi.jpg',
  alabama: 'File:Little River Canyon from Wolf Creek Overlook, April 2018 1.jpg',
  muck: 'File:Camas na Cairidh, Isle of Muck - geograph.org.uk - 7181002.jpg',
  bute: 'File:Rothesay from Serpentine Road.jpg',
  saxony: 'File:Dresden Elbe Valley (53).jpg',
  mezquita: 'File:Córdoba - Mezquita-Catedral - Interior - 10.jpg',
  sikinos: 'File:Kastro in Chora of Sikinos, 247997.jpg',
  adelaide: 'File:Adelaide - Torrens River - panoramio.jpg',
  spetses: 'File:Old port on Spetses island, Greece (48760272116).jpg',
}
...
console.log('All batch19 handpicks saved')
