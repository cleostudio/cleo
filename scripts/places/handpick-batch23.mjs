#!/usr/bin/env node
/**
 * Pin known-good Commons heroes for batch23 weak/wrong auto-curations.
 *
 *   node scripts/places/handpick-batch23.mjs
 */
...
const UA = 'cleo-places-curate/1.0 (batch23-handpick-persist)'

const HANDPICKS = {
  leicester: 'File:Leicester Clock Tower wide view.jpg',
  coventry: 'File:Coventry Cathedral Ruins with Rainbow edit.jpg',
  southampton: 'File:Southampton Bargate at Dusk (2).jpg',
  rennes: 'File:Palais du parlement de Bretagne, Rennes.jpg',
  grenoble:
    'File:Grenoble-Bastille cable car - Téléphérique de Grenoble Bastille photo1.jpg',
  padua: 'File:Prato della Valle e Santa Giustina Padova 2010.jpg',
  salzburg: 'File:Domplatz, Salzburg 11.jpg',
  brno: 'File:Brno Spilberk vyhled Petrov.jpg',
  thessaloniki: 'File:The White Tower of Thessaloniki - 2.jpg',
  izmir: 'File:Izmir Konak Square and Clock Tower, 2026.jpg',
  linz: 'File:Linz Dunaj 07.jpg',
  idaho: 'File:Sawtooth Valley ID1.jpg',
  montana: 'File:Sun Road, Glacier National Park.jpg',
  nevada: 'File:Road in Valley of Fire.jpg',
  anglesey:
    'File:South Stack and South Stack Lighthouse - geograph.org.uk - 5482247.jpg',
  hiiumaa: 'File:Kõpu tuletorn Hiiumaal.jpg',
  graubunden: 'File:Sankt Moritz Lake Piz Muragl.jpg',
  'castile-la-mancha': 'File:Windmills of Consuegra (7079300441).jpg',
  mycenae: 'File:Lion Gate, Mycenae, 201505.jpg',
  parthenon: 'File:Parthenon from west.jpg',
  tikal: 'File:Plaza of the Seven Temples, Tikal 25.jpg',
  palenque:
    'File:Temple of the Inscriptions, view from The Palace - Palenque Maya Site, Feb 2020.jpg',
}
...
console.log('All batch23 handpicks saved')
