...
const UA = 'cleo-places-curate/1.0 (batch5-handpick-persist)'

const JOBS = [
  [
    'toronto',
    ['Toronto skyline CN Tower day', 'Toronto waterfront skyline'],
  ],
  [
    'san-francisco',
    ['Golden Gate Bridge San Francisco day', 'San Francisco skyline daytime'],
  ],
  [
    'milan',
    ['Duomo di Milano facade', 'Milan Cathedral piazza'],
  ],
  [
    'jakarta',
    ['Monas Jakarta Merdeka Square', 'Jakarta skyline Indonesia'],
  ],
  [
    'manila',
    ['Manila Bay sunset Roxas', 'Intramuros Manila walls'],
  ],
  [
    'queensland',
    ['Daintree rainforest Queensland', 'Queensland Gold Coast skyline', 'Great Barrier Reef Queensland coast aerial'],
  ],
  [
    'maui',
    ['Haleakala crater Maui', 'Maui coastline Hawaii', 'Road to Hana Maui coast'],
  ],
  [
    'rhodes',
    ['Rhodes Old Town harbour', 'Lindos Rhodes acropolis', 'Medieval City of Rhodes walls'],
  ],
  [
    'johannesburg',
    ['Johannesburg skyline South Africa', 'Johannesburg CBD skyline day'],
  ],
  [
    'tahiti',
    ['Tahiti island aerial lagoon', 'Tahiti volcanic peaks coast'],
  ],
]
...
async function searchPick(query) {
  ...
  for (const page of Object.values(data.query?.pages ?? {})) {
    ...
    if (
      /\b(map|flag|opal|gem|mineral|ship|imo|oakland|harbour \(916|portrait|interior|church of the virgin|colonial-houses|firework|night|bei nacht|bridge western span at night)\b/i.test(
        title,
      )
    ) {
      continue
...
console.log('All batch5 handpicks saved')
